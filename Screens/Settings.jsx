    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.item}>
        <View style={styles.itemLeft}>
          <MaterialIcons name="notifications" size={22} color="#f48fb1" />
      ...
      <View style={styles.item}>
        <View style={styles.itemLeft}>
          <MaterialIcons name="mark-email-unread" size={22} color="#f48fb1" />
      ...
      <View style={styles.item}>
        <View style={styles.itemLeft}>
          <MaterialIcons name="dark-mode" size={22} color="#f48fb1" />
      ...
      <TouchableOpacity style={styles.linkItem}>
        <View style={styles.itemLeft}>
          <MaterialIcons name="shield" size={22} color="#f48fb1" />
      ...
      <TouchableOpacity style={styles.linkItem}>
        <View style={styles.itemLeft}>
          <MaterialIcons name="gavel" size={22} color="#f48fb1" />
      ...
      <TouchableOpacity style={styles.linkItem}>
        <View style={styles.itemLeft}>
          <MaterialIcons name="help-center" size={22} color="#f48fb1" />
      ...
      <TouchableOpacity style={[styles.linkItem, { justifyContent: "center" }]}>
        <View style={styles.itemLeft}>
          ...
          <Text style={[styles.itemText, { color: "#e53935", fontWeight: "bold" }]}>
            Log Out
          </Text>
        </View>
      </TouchableOpacity>
